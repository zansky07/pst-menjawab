...
<body style="margin: 0; height: 260vh;" class="bg-oranye-1">
    <main class="flex-grow container-fluid mx-auto mt-0 bg-oranye-1" style="background-image: url('<?= base_url('assets/images/bg-welcome.png') ?>'); background-size: cover; background-position: top; height: 65vh;">
