    ...
    <nav class="bg-white shadow shadow-gray-300 fixed top-0 left-0 w-full px-8 z-50">
        <div class="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
            <div class="flex items-center space-x-4">
                ...
                <span class="text-gray-800 font-semibold text-sm md:text-base"> PST Menjawab BPS Provinsi DKI Jakarta
                </span>
            </div>
                ...
                <ul class="flex font-semibold items-center justify-between space-x-4">
                    ...
                    <li class="relative">
                        <button id="dropdownNavbarLink"
                            class="text-gray-700 hover:bg-gray-50 md:hover:bg-transparent py-2 md:hover:text-blue-700 flex items-center">
                                    ...
                                    <td class="py-2 px-4">
                                        <div class="flex justify-around">
                                            <a href="/admin/consultation/detail/<?= $request['id'] ?>"
                                                class="bg-green-500 text-white py-1 px-2 rounded-full w-full text-center mx-1 text-sm transition duration-300 hover:bg-green-600">Detail</a>
                                            <a href="/admin/consultation/delete/<?= $request['id'] ?>"
                                                class="bg-red-500 text-white py-1 px-2 rounded-full w-full text-center mx-1 text-sm transition duration-300 hover:bg-red-600">Hapus</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
            ...
            <div class="flex justify-between items-center w-full max-w-6xl mb-8 space-x-8">>
                ...
                <div class="w-1/3 text-left">
                    ...
                    <ul class="list-none text-base">
                        ...
                        <li><a href="https://jakarta.bps.go.id" class="underline">Website BPS Provinsi DKI Jakarta</a>
                        </li>
                        <li><a href="https://pst.bps.go.id" class="underline">Website Pelayanan Statistik Terpadu</a>
                        </li>
